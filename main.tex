...
\\
Thesis: Mathematical and computational modeling of metallic biomaterials biodegradation ({\href{https://mbarzegary.github.io/phd-thesis-website/}{view it online}})
...
\item
Senior software developer, Amirkabir Science and Technology Park \hfill 2016--2018
\\
...
\item Software developer, Avizheh Information Technology inc. \hfill 2008--2014
\\
...
\begin{enumerate}[itemsep=-0.2ex]
\item
\textbf{M. Barzegari}, M. de Waal, D. Bordignon, A. Rosinaite, A. Forner-Cuenca, ``\href{https://doi.org/10.26434/chemrxiv.10001658/v1}{RfbFoam: An open-source framework for porous electrode modeling in redox flow batteries}'', ChemRxiv Preprint
\item
M. van der Heijden, \textbf{M. Barzegari}, A. Forner-Cuenca, ``\href{https://dx.doi.org/10.2139/ssrn.6135697}{Enhancing mass transport in redox flow batteries with 3D-printed triply periodic minimal surface electrode structures}'', SSRN Preprint
\item
...
\begin{enumerate}[itemsep=-0.2ex]
\item
(Poster presentation) \textbf{M. Barzegari}, A. Rosinaite, M. de Waal, P. de Carvalho, T. Jans, D. Bordignon, A. Forner-Cuenca, "Computational modeling for design optimization of porous electrodes in redox flow batteries", Dutch Computational Science Day (DUCOMS), 2025
\item
(Poster presentation) \textbf{M. Barzegari}, A. Rosinaite, M. de Waal, P. de Carvalho, T. Jans, D. Bordignon, A. Forner-Cuenca, "Multi-scale computational design and optimization of porous electrodes in electrochemical flow cells and redox flow batteries", 5th European Congress of Chemical Engineering (ECCE), 2025
\item 
(Oral presentation) 
...
\begin{itemize}[itemsep=-0.2ex]
\item
Multiphase computational fluid dynamics (MSc), TU/e, \hfill 2025--2026\\
Lecture on real-world CFD applications, mentoring hands-on sessions and group assignments 
\item 
...
\begin{itemize}[itemsep=-0.2ex]
\item
Ms. Sheetal Prasad: "Computational modeling of catalyst layer structure in membrane-free water electrolyzers", TU/e\hfill 2025--2026
\item
...
\item
\textbf{Machine Learning} Scikit-learn, Keras, TensorFlow, PyTorch, JAX, NVIDIA PhysicsNeMo
%\item

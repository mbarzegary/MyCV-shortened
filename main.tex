...
\item
\textbf{Ph.D.} in Computational Biomedical Engineering, KU Leuven, Belgium \hfill 2018 -- Now
\\
Thesis: Mathematical and computational modeling of biodegradation behavior of personalized printed implants (Supervisor: Prof. Liesbet Geris)

\item
\textbf{M.Sc.} in Biomedical Engineering, University of Tehran, Iran \hfill 2011 -- 2014
\\
Thesis: Computational analysis of dynamics of urine flow in the lower urinary system in the physiological and pathological conditions using FSI method (Supervisor: Prof. Bahman Vahidi)


\item
\textbf{B.Sc.} in Materials Science and Engineering, Tehran Polytechnic, Iran \hfill 2006 -- 2011
\\
Thesis: Prediction of microshrinkage porosities using the permeability parameter modeled with artificial neural networks in Al alloys by finite volume method (Supervisor: Prof. S.M.H. Mirbagheri)
...
\item
Ph.D. researcher, KU Leuven, Belgium \hfill 2019 -- Now
\\
...
\item
Journal of Open Source Software\hfill 2022
\item
Springer Multimedia Tools and Applications (for machine learning topics)\hfill 2020--2022
\item
...
\item
Member of Virtual Physiological Human Institute (VPHi) student committee \hfill 2021-2022
\end{itemize}
...
\begin{itemize}[itemsep=-0.2ex]
\item
Active member of FreeFEM community (\href{https://community.freefem.org/}{community.freefem.org}) \hfill 2019-2022
\item
Blogging on technical aspects of scientific computing (\href{https://mbarzegary.github.io/blog}{mbarzegary.github.io/blog})\hfill 2020-2022
\item
Constantly sharing developed models and codes on GitHub (\href{https://github.com/mbarzegary}{github.com/mbarzegary}) \hfill 2018-2022
\item
Starting TuxRiders project for sharing open-source scientific computing experiences \hfill 2021-2022
\\ (\href{http://www.tuxriders.com/}{TuxRiders.com}) (\href{https://www.youtube.com/TuxRiders}{youtube.com/TuxRiders})
\begin{itemize}[itemsep=-0.2ex]
\item 70 videos, \textasciitilde 40,000 views (in 1.5 years)
\item \textasciitilde 750 subscribers (in 1.5 years)
\end{itemize}
\end{itemize}

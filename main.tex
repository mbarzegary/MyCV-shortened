...
\begin{enumerate}[itemsep=-0.2ex]
\item
\textbf{M. Barzegari}, A. Forner-Cuenca, ``\href{https://doi.org/10.26434/chemrxiv-2024-t7dtf}{Topology optimization of porous electrodes for electrochemical flow reactors using the finite element method and triply periodic minimal surfaces}'', ChemRxiv Preprint
\item
